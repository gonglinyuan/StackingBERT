...
def load_bert_model(args, trainer):
    if args.task == 'bert':
        trainer.load_doubled_checkpoint(args.load_bert, args.reset_optimizer, eval(args.optimizer_overrides))
    else:
        extra_state, _, _ = utils.load_bert_state(args.load_bert, trainer.get_model(), upgrade=True)
